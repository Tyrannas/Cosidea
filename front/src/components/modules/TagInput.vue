<template>
    <div class="tag_selection" @blur="toggleSearch(false)" :tabindex="0">
        <div class="tag_container">
            <span class="selected_tag" v-for="tag in value" :key="tag">
